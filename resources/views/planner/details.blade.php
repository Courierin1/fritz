    ...
    <div class="container-fluid" id="create-org">
        <div class="row">
            ...
            <div class="col-md-12">
                ...
                <form id="details" method="POST" action="{{ route('user.create.event.details.post')}}" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control" rows="5" col="5" name="summary" required
                            placeholder="Write a short event summary to get attendees excited">{{old('summary')}}</textarea>
                    </div>
                    ...
                    <input type="hidden" name="event_form_type" value="create">
