        ...
        <div class="row">
            ...
            <div class="col-md-12">
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="box box-widget widget-user">
                                    ...
                                    <div class="widget-user-image">
                                        <img style="width:100%;height: auto;" class="img-circle"
                                        src="{{asset($event->image ? $event->image : "assets/images/avatar/avatar.jpg")}}"  alt="User Avatar">
                                    </div>
                                        ...
                                        <div class="radio">
                                            <label>
                                                <input type="radio" class="public" name="public" id="optionsRadios1"
                                                    value="public" {{$event->status ==1 ? 'checked' : ''}}>
                                        ...
                                        <div class="radio">
                                            <label>
                                                <input type="radio" class="private" name="public" id="optionsRadios2"
                                                    value="draft" {{$event->status ==2 ? 'checked' : ''}}>
                ...
                <input type="hidden" name="event_id" value="{{$event->id}}">
                        <input type="hidden" name="event_form_type" value="update">
                <div class="box-footer">
