                                    ...
                                    <table id="user_orders" class="table table-hover">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>{{$eventOrder->payment_method}}</td>
                                                ...
                                                <td>
                                                    ...
                                                    data-href="{{ route('update_refund_request', $eventOrder->refundRequest->id ) }}"
                                                    >
                                                ...
                                                <td>
                                                    <a href="{{route('user.order.detail',$eventOrder->id)}}"><i class="fa-solid fa-eye" title="View"></i></a>
                                                </td>
                                            </tr>
                                            @endforeach
                                        </tbody>
